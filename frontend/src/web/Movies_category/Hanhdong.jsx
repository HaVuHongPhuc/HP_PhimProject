...
const Hanhdong = () => {
 ...
 const filteredMovies = movies.filter((movie) => {
    if (movie.category !== "Phim hành động") return false; // Lọc phim có category là "Hành động"
  ...
  ></div>
      ...
      <div className="p-8">
        <h1 className="mb-6 text-2xl font-bold text-white">Danh sách phim Hành động</h1>
